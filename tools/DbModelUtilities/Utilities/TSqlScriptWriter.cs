...
namespace DatabaseUtilities.Utilities
{
    public class TSqlScriptWriter : IDisposable
    {
        ...
        private static Identifier GO() => Identifier("go\r\n\r\n", QuoteType.NotQuoted);

        private static Identifier Identifier(string value, QuoteType type = QuoteType.SquareBracket) =>
            new Identifier {Value = value, QuoteType = type};
